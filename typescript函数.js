...
function myfuntion6(firstName, secondName) {
    if (secondName === void 0) { secondName = "default string"; }
    console.log("first name is " + firstName + " and second name is " + secondName + " by default");
}
myfuntion6("chan");
//入参包含可选参数
function myfuntion7(firstName) {
    if (firstName) {
